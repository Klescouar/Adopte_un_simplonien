...
<div class="searchPage" ng-controller='searchCtrl'>
    <div class="searchBar">
        ...
        <div class="cardPage">
            ...
            <a class="card" href="#/profil{{student.id}}" ng-repeat="student in studentShow | filter:searchStudent:q track by $index">
                <?php } else { ?>
                <a class="card" data-toggle="modal" data-target="#signInUp" ng-repeat="student in studentShow | filter:searchStudent:q track by $index">
                    <?php } ?>
                <div class="topCard">
