app.service("serviceApi", function(){
  ...
  this.api =  'http://localhost/MAMP/Adopte_un_simplonien/server/index.php/api/card';
  this.profilUser = 'http://localhost/MAMP/Adopte_un_simplonien/server/index.php/api/simplonien/';
  this.filter = 'http://localhost/MAMP/Adopte_un_simplonien/server/index.php/api/cardFiltre';
  ...
  this.createUser = 'http://localhost/MAMP/Adopte_un_simplonien/server/index.php/api/create/user';
  this.getUser = 'http://localhost/MAMP/Adopte_un_simplonien/server/index.php/api/user';
  this.deleteUser = 'http://localhost/MAMP/Adopte_un_simplonien/server/index.php/api/delete/user/';
  this.createStudent = 'http://localhost/MAMP/Adopte_un_simplonien/server/index.php/api/create/simplonien';
  this.getSimplonien = 'http://localhost/MAMP/Adopte_un_simplonien/server/index.php/api/listeSimplonien';
  this.deleteSimplonien = 'http://localhost/MAMP/Adopte_un_simplonien/server/index.php/api/delete/simplonien/';
  this.modifySimplonien = 'http://localhost/MAMP/Adopte_un_simplonien/server/index.php/api/simplonien/';
  this.modifySendSimplonien = 'http://localhost/MAMP/Adopte_un_simplonien/server/index.php/api/modify/simplonien/';
});
